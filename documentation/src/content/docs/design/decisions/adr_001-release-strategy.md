...
LIFETRACERは8つの外部サービスと連携し、データを統合・分析するプロジェクト。当初は「サービス追加ごとにバージョンアップ」という戦略だったが、全サービスの同期が完了した現在、**価値を届けるタイミング**を基準にした戦略に変更する。
...
- [ロードマップ](/planning/roadmap)
- [実装状況](/status/implementation)
