...
- [ADR-003 フィードバックループ](/design/decisions/adr_003-feedback-loop) - 4 Information概念
- [004 目標管理（target）](/specifications/schema/core/004-target) - 目標管理
- [003 統合時間ビュー](/specifications/schema/core/003-time-records-unified) - actual/plan統合
