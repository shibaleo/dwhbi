...
設計決定の詳細は [ADR-005 モノレポ構成](/100-development/130-design/131-decisions/adr_005-monorepo-structure) を参照。
...
- [モノレポ移行計画](/300-management/310-status/migration-plan) - 移行計画
- [DWH 4層アーキテクチャ](/000-foundations/020-philosophy/024-dwh-architecture) - 設計哲学
- [DWH技術仕様](/100-development/120-specifications/121-overview/dwh-layers) - スキーマ設計
