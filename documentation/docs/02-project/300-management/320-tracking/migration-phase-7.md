...
- [リポジトリ構成](/01-product/100-development/120-specifications/121-overview/repository-structure)
...
[Phase 8: connector の TypeScript 移行](/02-project/300-management/320-tracking/migration-phase-8)

## 関連ドキュメント

- [モノレポ移行計画](/02-project/300-management/310-planning/migration-plan) - 全体計画
- [Phase 6: CI/CD 更新](/02-project/300-management/320-tracking/migration-phase-6) - 前のフェーズ
