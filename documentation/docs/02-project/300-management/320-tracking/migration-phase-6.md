...
[Phase 7: クリーンアップ](/02-project/300-management/320-tracking/migration-phase-7)

## 関連ドキュメント

- [モノレポ移行計画](/02-project/300-management/310-planning/migration-plan) - 全体計画
- [Phase 5: テスト構成の整理](/02-project/300-management/320-tracking/migration-phase-5) - 前のフェーズ
- [CI/CD 基準](/01-product/200-quality/220-standards/cicd) - CI/CD 基準
