...
| 機能 | 優先度 | 備考 |
|------|:------:|------|
| **analyzer プロジェクト** | 高 | estimate 自動計算（LightGBM、[125 推定値計算ロジック](/01-product/100-development/120-specifications/125-analyzer/time/001-estimation#実装ステータス)） |
| **console.target GUI** | 高 | target の管理画面 CRUD / SCD Type 2（[125 目標値調整ロジック](/01-product/100-development/120-specifications/125-analyzer/time/002-adjust-target-by-estimate#target-テーブル設計console-スキーマ--scd-type-2)） |
