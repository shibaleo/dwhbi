...
詳細は [131 ADR-002 分析軸マスタ設計](/01-product/100-development/130-design/131-decisions/adr_002-ref-schema-design) を参照。
...
詳細は [121 DWH技術仕様](/01-product/100-development/120-specifications/121-overview/dwh-layers) を参照。
...
時間は **social（対外的・共有可能な分類）** と **personal（内省的・個人的分類）** の2軸で分類する。マスタはサービス非依存、マッピングでサービス固有値を変換。詳細は [131 ADR-002](/01-product/100-development/130-design/131-decisions/adr_002-ref-schema-design) を参照。
